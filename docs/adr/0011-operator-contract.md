...
- **Failures (#190, #196, #197, #200):** a failed operator command prints the AXI block `error:`, `code:`, `help:`. The operator side has its own closed code list, separate from the step side. Each code is named by the ticket that needs it.
