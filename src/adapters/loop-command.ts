/** `loopfile loop <source> --times N | --list <file> | --next <command> [--retry N] -d` (#60, #62, #63, #64). */
...
const USAGE =
  "Usage: loopfile loop <source> (--times N | --list <file> | --next <command>) [--input k=v]... [--retry N] [-d]";
const HELP = `${USAGE}
